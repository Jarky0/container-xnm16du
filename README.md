...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xnm16du.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xnm16du.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jarky0/container-xnm16du.git
cd container-xnm16du
```
...
```
docker attach container-xnm16du
```
